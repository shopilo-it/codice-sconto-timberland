#!/usr/bin/env python3
"""
Recupero codici sconto Timberland da shopilo.it
Sursa: https://shopilo.it/negozi/timberland.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/timberland.it"
STORE_NAME = "Timberland"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Timberland da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-timberland)"
    }
    try:
